  ...
  return (
    <div className="rounded-lg border border-border-subtle bg-surface overflow-hidden">
      ...
      <div className="flex items-center gap-3 p-3">
        ...
        <button
          onClick={() => setOpen((v) => !v)}
          className="flex h-12 w-14 shrink-0 items-center justify-center rounded-md bg-surface-elevated border border-border-subtle hover:border-orange-500/50 transition-colors group"
        ...
        >
          {open ? (
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-orange-500 group-hover:scale-110 transition-transform">
